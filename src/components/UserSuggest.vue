  ...
  <div class="control-wrapper" @click="inputRef?.focus()">
    ...
    <div class="left-icon">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path
          d="M4 6C4 4.89543 4.89543 4 6 4H10C14.4183 4 18 7.58172 18 12C18 16.4183 14.4183 20 10 20H6C4.89543 20 4 19.1046 4 18V6Z"
          stroke="#BCED0A"
          stroke-width="3"
        />
      </svg>
